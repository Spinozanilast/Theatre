...
namespace Theatre.Infrastructure.Data.Migrations
{
    ...
    [Migration("20241107094119_RemoveDuplicatingDataFromTickets")]
    partial class RemoveDuplicatingDataFromTickets
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Theatre.Domain.Entities.Ticket", b =>
                {
                    ...
                    b.HasIndex("EventId", "UserId", "HallId", "SeatIds")
                        .IsUnique()
